...
[⏪ **PREVIOUS** < _Предыдущая страница_ ⏪](/_ITM_old_version_FOR_DELETE/ITM01_Core1/3_Core1_ProcedureJava.md)
...
// [**Скрин** всей страницы источника](/_ITM_old_version_FOR_DELETE/ITM01_Core1/files/Архитектура%20виртуальной%20машины%20Java_.html)   
...
![`private` и `protected` _ к верхнеуровневым классам](/_ITM_old_version_FOR_DELETE/ITM01_Core1/imgs/2025-03-05_10-21-26.png)
...
[>>> **NEXT** > _Следующая страница_ >>>](/_ITM_old_version_FOR_DELETE/ITM01_Core1/5_Core1_Exceptions.md)
