...
## [Что такое инверсия контроля (`IoC`) и внедрение зависимостей (`DI`)? Как эти принципы реализованы в `Spring`?](/_ITM_old_version_FOR_DELETE/ITM06_Spring/by_questions/IoC_&_DI_for_Spring.md)
...
## [Что такое `IoC` контейнер?](/_ITM_old_version_FOR_DELETE/ITM06_Spring/by_questions/IoC_container.md)
...
## [Расскажите про `ApplicationContext` и `BeanFactory`, чем отличаются? <br>В каких случаях что стоит использовать?](/_ITM_old_version_FOR_DELETE/ITM06_Spring/by_questions/BeanFactory_VS_ApplicationContext.md)
...
[🌟 `@Bean` и `@Configuration`: Как это работает? 🌟](/_ITM_old_version_FOR_DELETE/ITM06_Spring/otc/@Bean_with_@Configuration_vs_@Component.md)
...
детально про [`@Repository`](/_ITM_old_version_FOR_DELETE/ITM06_Spring/otc/@Repository_Exception_Handling.md)

детально про [`@Controller`](/_ITM_old_version_FOR_DELETE/ITM06_Spring/otc/@Controller_Detailed_Guide.md)
...
---
![@Component](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-23_17-25-00.png)
...
#### 🛢️ [`@Repository`](/_ITM_old_version_FOR_DELETE/ITM06_Spring/otc/@Repository_Exception_Handling.md)
...
#### 🌐 [`@Controller`](/_ITM_old_version_FOR_DELETE/ITM06_Spring/otc/@Controller_Detailed_Guide.md)
* Указывает, что класс — **веб-контроллер**.
* Обрабатывает HTTP-запросы.
* Используется в _Spring MVC_.

#### 🛰️ `@RestController`
* Расширяет [`@Controller`](/_ITM_old_version_FOR_DELETE/ITM06_Spring/otc/@Controller_Detailed_Guide.md).
...
![@Bean](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-23_17-38-50.png)
...
[Типы внедрения зависимостей с `@Autowired`](/_ITM_old_version_FOR_DELETE/ITM06_Spring/otc/@Autowired_Injection_Types.md)
...
![пример](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-22_16-12-00.png)
...
## [Расскажите про жизненный цикл бина, аннотации @PostConstruct и @PreDestroy()](/_ITM_old_version_FOR_DELETE/ITM06_Spring/by_questions/spring_bean_life_cycle.md)
...
![Создание экземпляров бинов](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-17_23-23-14.png)

Иллюстрация1: _жизненный цикл_ `Spring Bean`
![жизненный цикл Spring Bean _1](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-17_23-25-36.png)

Иллюстрация2: _жизненный цикл_ `Spring Bean`
![жизненный цикл Spring Bean _2](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-23_07-55-37.png)
...
![диаграмма](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-23_12-41-45.png)
...
## [Как спринг работает с транзакциями? Расскажите про аннотацию `@Transactional`.](/_ITM_old_version_FOR_DELETE/ITM06_Spring/by_questions/@Transactional.md)
...
![как это выглядит Визуально](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-18_10-16-51.png)
...
![DisptacherServlet Spring’а и ViewResolver](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-18_11-13-10.png)
...
![Controller Spring’а и ViewResolver](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-18_11-15-48.png)
...
![UML for Front Controller Pattern:](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-19_07-55-30.png)
...
![DispatcherServlet -схема & диаграмма потока запроса](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-18_23-50-02%20(2).png)
...
![Диаграмма паттерна MVC](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-19_09-25-15.png)

![Диаграмма паттерна MVC в Spring УКРУПНЕННО](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-19_09-37-04.png)
...
![паттерн MVC](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-18_11-13-10.png)
...
![Диаграмма реализации паттерна MVC в Spring](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-19_09-33-34.png)
...
[см. заметку: Spring proxy / `CGLIB`](/_ITM_old_version_FOR_DELETE/ITM06_Spring/otc/Spring_proxy.md)

![Advice](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-05-01_13-49-10.png)

![Aspect](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-05-01_13-50-18.png)
...
![Filters](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-19_12-24-52.png)
...
![Interceptors](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-19_12-25-16.png)
...
[spring_security](/_ITM_old_version_FOR_DELETE/ITM06_Spring/by_questions/spring_security.md)
...
![Spring Security](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-21_14-13-12.png)
...
## Что такое SpringBoot? Какие у него преимущества? [Как конфигурируется?](/_ITM_old_version_FOR_DELETE/ITM06_Spring/by_questions/Spring_Boot_Autoconfiguration_Explained.md) Подробно.
...
![Автоконфигурация Spring Boot](/_ITM_old_version_FOR_DELETE/ITM06_Spring/imgs/2025-04-21_16-04-12.png)
