...
| **Операция \ Состояние сущности**  | **Transient** (_Новая_)                             | **Managed** (_Управляемая_)                              | **Detached** (_Отсоединенная_)                                                       | **Removed** (_Удаленная_)                            |
|------------------------------------|-----------------------------------------------------|----------------------------------------------------------|--------------------------------------------------------------------------------------|------------------------------------------------------|
| `persist`                          | Становится Managed; SQL `INSERT` при синхронизации. | Без эффекта.                                             | Ошибка `IllegalArgumentException`.                                                   | Становится Managed; SQL `INSERT` при синхронизации.  |
| `remove`                           | Ошибка `IllegalArgumentException`.                  | Становится Removed; SQL `DELETE` при синхронизации.      | Ошибка `IllegalArgumentException`.                                                   | Без эффекта.                                         |
| `merge`                            | Становится Managed; SQL `INSERT` при синхронизации. | Без эффекта.                                             | Становится Managed; данные копируются; SQL `INSERT` или `UPDATE` при синхронизации.  | Ошибка `IllegalArgumentException`.                   |
| `refresh`                          | Ошибка `EntityNotFoundException`.                   | Поля обновляются из БД; ошибки, если запись отсутствует. | Ошибка `IllegalArgumentException`.                                                   | Ошибка `EntityNotFoundException`.                    |
| `detach`                           | Без эффекта.                                        | Становится Detached; изменения не отслеживаются.         | Без эффекта.                                                                         | Становится Detached; изменения не отслеживаются.     |
