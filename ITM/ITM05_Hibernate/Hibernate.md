...
| 7️⃣     | `READ` (_устаревший_)         | 📖 *Синоним `OPTIMISTIC`.*                  | 📖 *устаревший* <br>Рекомендуется использовать `OPTIMISTIC` в новых приложениях.                                     |
| 8️⃣     | `WRITE` (_устаревший_)        | ✏️ *Синоним `OPTIMISTIC_FORCE_INCREMENT`.*  | ✏️ *устаревший* <br>Рекомендуется использовать `OPTIMISTIC_FORCE_INCREMENT` в новых приложениях.                     |
