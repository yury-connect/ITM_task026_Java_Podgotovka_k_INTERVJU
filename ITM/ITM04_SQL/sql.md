...
### 🔄 Виды шардинга
✅ **Вертикальный** (партиционирование) — разделение таблицы или группы таблиц 
...
📌 Используй шардинг, если данные не умещаются в одной БД, а репликацию, если нужны резервные копии для быстрого чтения. 🚀
