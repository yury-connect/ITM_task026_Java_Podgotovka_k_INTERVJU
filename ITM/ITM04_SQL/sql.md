...
🔹 В ячейках таблицы только **одно** значение.
...
🔹 Неключевые атрибуты не зависят друг от друга, а только от **первичного ключа** (_нет транзитивных зависимостей_).
...
✅ **5NF** – устраняет зависимости соединений (_избыточные разбиения данных_) / 
...
должна быть логическим следствием ограничений доменов и ключей. 
