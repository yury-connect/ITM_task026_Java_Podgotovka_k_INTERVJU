...
<details>
        <summary>50. Что такое «локальный класс»? Каковы его особенности?</summary>
...
<details>
        <summary>51. Что такое «анонимные классы»? Где они применяются?</summary>
...
<details>
        <summary>52 _доступ к полю внешнего класса?</summary>
...
<details>
        <summary>53. Что такое перечисления (enum)?</summary>
...
<details>
        <summary>54. Как проблема ромбовидного наследования решена в java?</summary>
...
<details>
        <summary>55. Что такое конструктор по умолчанию?</summary>
...
<details>
        <summary>56. Могут ли быть приватные конструкторы? Для чего они нужны?</summary>
...
<details>
        <summary>57. _классы-загрузчики и _динамическая загрузка классов.</summary>
...
<details>
        <summary>58. _конструкторы...</summary>
...
<details>
        <summary>59. _модификаторы модификаторы и классы?</summary>
...
<details>
        <summary>60. Что означает модификатор static?</summary>
...
<details>
        <summary>61. Может ли статический метод быть переопределён или перегружен?</summary>
...
* **Перегрузить** (_overload_) **можно**. Можно создать несколько статических методов с одинаковым именем, но разными параметрами (по количеству или типу).
```text
***** из методички *****
...
<details>
        <summary>62. Могут ли нестатические методы перегрузить статические?</summary>
...
<details>
        <summary>63. _сузить уровень доступа/тип возвр. знач-я при переопределении?</summary>
...
<details>
        <summary>64. _изменения в сигнатуре при переопределении / модификатора?</summary>
...
<details>
        <summary>65. Могут ли классы быть статическими?</summary>
...
<details>
        <summary>66. Что означает модификатор final? К чему он может быть применим?</summary>
...
<details>
        <summary>67. Что такое абстрактные классы? Чем они отличаются от обычных?</summary>
...
* **Абстрактный класс используется**, когда есть отношение "**is-a**", а интерфейсы подходят для общей функциональности, не связанной с иерархией.
