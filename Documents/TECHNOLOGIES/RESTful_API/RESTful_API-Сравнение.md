...
| ------------------------- | ------------ | -------------- | ---- | ------ | -------------------- | --------- |
| **Rest<br>Template**      | ✅            | ❌              | ✅    | ❌      | ✅                    | Низкая    |
| **Web<br>Client**         | ❌            | ✅              | ✅    | ✅      | ✅ <br>(WebFlux)      | Средняя   |
| **Http<br>Client (Java)** | ✅            | ✅              | ❌    | ✅      | ❌                    | Средняя   |
| **Feign**                 | ✅            | ❌*             | ✅    | ❌      | ✅ <br>(Spring Cloud) | Низкая    |
| **Retrofit**              | ✅            | ✅ <br>(RxJava) | ✅    | ✅      | ❌                    | Средняя   |
| **Apache HttpClient**     | ✅            | ✅ <br>(Async)  | ❌    | ❌      | ❌                    | Высокая   |
| **Unirest**               | ✅            | ✅              | ✅    | ❌      | ❌                    | Низкая    |
