**ELK-стэк** — это <u>набор технологий для сбора, хранения, анализа и визуализации логов и данных в реальном времени</u>. Название образовано от первых букв входящих в него компонентов:
- **E**lasticsearch    
- **L**ogstash    
- **K**ibana    
