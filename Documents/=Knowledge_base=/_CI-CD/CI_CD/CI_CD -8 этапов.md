...
| **5. DEPLOY**   | **Kubernetes**, **Docker**, [**Helm**](../../../TECHNOLOGIES/Оркестрация/Kubernetes/Helm/Helm_info.md), Terraform, AWS Lambda | Kubernetes + Docker — стандарт для контейнеризации Java-приложений; [Helm](../../../TECHNOLOGIES/Оркестрация/Kubernetes/Helm/Helm_info.md)] — управление charts. |
