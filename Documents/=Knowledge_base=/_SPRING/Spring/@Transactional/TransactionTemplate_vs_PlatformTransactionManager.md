...
Вся транзакционная "магия" Spring строится на нескольких ключевых интерфейсах и классах.
