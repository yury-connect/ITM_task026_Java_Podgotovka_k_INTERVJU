...
[⬅️**Previous**](Группа_05-Spring_MVC_и_REST.md)   //   [⬆️](SPRING-121_вопрос_на_middle.md)   //   [**Next**➡️](Группа_07-Spring_Data_&_БД.md)
...
[Подробности по данному вопросу...](Details/@Configuration_vs_@AutoConfiguration.md)
...
2. **Автоконфигурация** — `ServletWebServerFactoryAutoConfiguration` создает `TomcatServletWebServerFactory` (или Jetty/Undertow, если соответствующий стартер в classpath).   [Подробности по **Автоконфигурация**...](Details/@Configuration_vs_@AutoConfiguration.md)
