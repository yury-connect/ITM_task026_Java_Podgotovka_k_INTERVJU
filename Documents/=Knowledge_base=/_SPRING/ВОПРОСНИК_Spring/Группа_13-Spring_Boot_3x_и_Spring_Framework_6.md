...
[⬅️**Previous**](Группа_12-Странные_вопросы.md)          [⬆️](SPRING-121_вопрос_на_middle.md)
...
---
### 120. Что изменилось в Spring Boot 3? <br>(Java 17 baseline, Jakarta EE 9+ вместо javax)
