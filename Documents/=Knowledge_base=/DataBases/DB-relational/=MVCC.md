...
Снимок — это "мгновенный снимок" состояния базы данных на момент начала запроса или транзакции, который определяет, какие версии строк видны. Он состоит из трех ключевых чисел [](https://postgrespro.com/blog/pgsql/5967899)[](https://www.highgo.ca/2024/04/19/a-deeper-look-inside-postgresql-visibility-check-mechanism/):
