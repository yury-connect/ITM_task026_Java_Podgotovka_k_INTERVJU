...
1. **Строка 1 (xmin = 3695):** Добавлена до снимка, но **еще не закоммичена**. При создании снимка она была в списке `xip` (активных).
...
3. **Строка 3 (xmin = 3697):** Добавлена **после** создания снимка. Её ID больше `snapshot.xmax`.
