...
1. **PostgreSQL**    
    ...
    - Для устранения **фантомов** на уровне `REPEATABLE READ` использует [**MVCC**](PostgreSQL/=MVCC.md)  (многоверсионность) 4.
    
2. **MySQL (InnoDB)**    
    - На уровне `REPEATABLE READ` также предотвращает фантомы благодаря [**MVCC**](PostgreSQL/=MVCC.md)  13.        
