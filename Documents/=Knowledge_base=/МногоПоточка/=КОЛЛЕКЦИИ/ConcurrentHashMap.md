...
![|1024x317](./_Attachments_ConcurrentHashMap/image.png) Блокировка ***synchronize***  захватывается по монитору **первого** элемента в бакете
![|1024x562](./_Attachments_ConcurrentHashMap/image-1.png)
