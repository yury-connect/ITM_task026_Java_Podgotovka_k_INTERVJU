...
- **Major GC (*старый*)** — чистит <u>старое</u> поколение (`Old Gen`).
    ...
    - Включает процедуру **уплотнения (*компактизации*) памяти**, при которой живые объекты сдвигаются в начало области, оставляя **непрерывный** кусок свободной памяти **в конце** области.
