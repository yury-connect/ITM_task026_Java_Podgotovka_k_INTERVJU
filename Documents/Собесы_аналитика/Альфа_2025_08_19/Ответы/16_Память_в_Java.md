# Память в Java (HotSpot/JVM) — максимально подробно и структурно 🔥
...
- **Кадр (*frame*)**: локальные переменные, операндный стек, ссылочные/примитивные значения, ссылку на constant pool.
