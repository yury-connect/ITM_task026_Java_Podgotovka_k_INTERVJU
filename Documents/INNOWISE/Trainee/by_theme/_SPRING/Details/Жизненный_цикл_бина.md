...
└─────────────────────────────────────────┘
       ...
       ▼
┌───────────────────────────────────────────────────────┐
│ 2.1 ДОБАВЛ. НОВЫХ и МОДИФИК. ИМЕЮЩИХСЯ BeanDefinition │
│    - BeanDefinitionRegistryPostProcessor -добавлять BD│
│    - BeanFactoryPostProcessor -только модифицировать  │
└───────────────────────────────────────────────────────┘
       │
       ▼
┌────────────────────────────────────────────────────┐
│ 2. ОБРАБОТКА BEAN FACTORY POST PROCESSOR           │
│    - Модификация метаданных/ определений                       │
