...
2. **Автоконфигурация** — `ServletWebServerFactoryAutoConfiguration` создает `TomcatServletWebServerFactory` (или Jetty/Undertow, если соответствующий стартер в classpath).
