Middle Java Developer. Список ранжирован по приоритетности: от фундаментальных основ и Spring-реализации до низкоуровневых оптимизаций.

## Фундаментальные основы и архитектура (Must-have)
...
---
## Продвинутая разработка и отказоустойчивость
...
---
### Глубокое понимание и инфраструктура (Deep Dive)
