...
---
### Группа 1: [Основы IoC и DI](Группа_01-Основы_IoC_и_DI)
*(Задают в 99% случаев)*
...
### Группа 3: [AOP (Aspect Oriented Programming)](Группа_03-AOP)
...
### Группа 4: [Управление транзакциями (Очень высокая частота)](Группа_04-Управление_транзакциями)
...
### Группа 5: [Spring MVC и REST (Очень высокая частота)](Группа_05-Spring_MVC_и_REST)
...
### Группа 6: [Spring Boot Core (Средне-высокая частота)](Группа_06-Spring_Boot_Core)
...
### Группа 7: [Spring Data и Работа с БД (Очень высокая частота)](Группа_07-Spring_Data_&_БД)
...
### Группа 8: [Безопасность (Spring Security) — Для Middle часто базово](Группа_08-Spring_Security)
...
### Группа 9: [Тестирование (Важно для Middle)](Группа_09-Тестирование)
...
### Группа 10: [Асинхронность, События, Задачи (Средняя частота)](Группа_10-Асинхронность_События_Задачи)
...
### Группа 11: [Внутренности и продвинутые темы (Ниже средней, но для сильного Middle)](Группа_11-продвинутые_темы)
...
### Группа 12: [«Странные вопросы» на знание нюансов (Редко, но метко)](Группа_12-Странные_вопросы)
...
### Бонус: [Spring Boot 3.x и Spring Framework 6 (Новые темы)](Группа_13-Spring_Boot_3x_и_Spring_Framework_6)
